...
function onInput (evt){
    ...
    fetchCountries(countryInput).then(
    (countryItem) =>{
        console.log(countryItem.length)
       
if  (countryItem.length > 10){Notiflix.Notify.info('Too many matches found. Please enter a more specific name.')}
...
return  arr.map(country =>  
   ...
   <p> <b>Languages: </b>${Object.values(country.languages).join(`,`)}</p>
         ...
         function createMarkupList (array){
            return array.map(country => `<li class = "card">
            <div class = "container">
            <img src="${country.flags.png}" alt="flag of ${country.name.official}" width = 50px  height = 30px>
